...
export default function Cart (){
    ...
    if(!products.length)return <h1 className="flex flex-col justify-center items-center h-screen">There is no products in the cart</h1>
    ...
    const stripePromise = loadStripe('pk_test_51HxMyeFjaqj6StBqxH7qGQDgMFsPUf5RJbOBB2c5UuO0oL0OfW81QY8VTZ3J6kVdMDg8U9qHq64DSR2bcKSKGgFX00b2C14se0');
    ...
    return (
        ...
        <div className="relative bg-white bottom-0 border-t border-gray-300 flex flex-col items-center w-full h-34 md:h-1/5">
            ...
            <section className="bg-white p-4 text-md h-2/5 w-full text-center text-gray-600 flex flex-row justify-between sm:w-4/12 sm:p-2"> <span>Sub total:</span> <span>usd { finalPrice }</span></section>
        ...
        
        {
            (showPaymentForm)?
                ...
                <Elements stripe={ stripePromise }>
                    <CheckoutForm finalPrice={ finalPrice } setPaymentForm={ setPaymentForm } />
                </Elements>
            :''
        }
        </div>
